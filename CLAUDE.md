...
# This repo: `dicta-task`  ·  clade `ap-dicta-task`

- **Identity** — uuid `7aff6bbd-b776-503f-ba55-3f67c7106886`; clade `ap` (secondary ``); born 2026-03-14; forge `hyperpolymath/dicta-task`.
- **IS** — Speech-to-do pipeline: portable recorder → transcription → NLP parsing → prioritised task list
- **IS-NOT** — a cloud dictation service (ASR runs offline; cloud is encrypted backup only) · a general note-taking app · a template (it is minted from rsr-template-repo)
- **Where it sits** — pipeline position **leaf**; chain `standards → rsr-template-repo → dicta-task`; coordination = `standards`.
...
<!-- ARRIVAL-PACK:END · provenance: CLADE@9a15c2cf0137 ECOSYSTEM@3583d7f719c7 AGENTIC@89960466d05d STATE@632b130c47da ANCHOR@9e3825aa4a56 · Manifesto@DRAFT-unratified · regenerate: `just claude-md` (k9 drift-detects; do not hand-edit above) -->
