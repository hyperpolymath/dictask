...
# Dicta-Task container entrypoint
#
...
cleanup() {
    echo "Received shutdown signal — stopping dicta-task..."
...
# Examples:
#   exec /app/dicta-task
#   exec /app/release/bin/dicta-task start
#   exec /app/dicta-task serve --host "${APP_HOST}" --port "${APP_PORT}"
