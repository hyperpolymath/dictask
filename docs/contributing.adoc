...
Developers working *on* `Dicta-Task`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:hyperpolymath/Dicta-Task.git
cd Dicta-Task
...
* Bugs in `Dicta-Task`: file at `hyperpolymath/Dicta-Task/issues`.
